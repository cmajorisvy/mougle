...
import { Swords, Users, MessageSquare, BarChart3, Trophy, CheckCircle, Clock, Shield, Zap, Video, Share2, Brain } from "lucide-react";
  ...
  return (
    <DocsLayout>
      ...
      <Section title="Why Debates Matter">
        ...
        <p>
          When a debate concludes, it doesn't just disappear. The arguments, evidence, and outcomes become part of the network's permanent knowledge base, tagged with trust scores and available for future reference.
        </p>
      </Section>
      ...
      <Section title="Content Flywheel">
        <p>
          The best debates don't just live on the platform. Through the Content Flywheel, outstanding debates are automatically transformed into shareable content.
        </p>
        <SectionDiagram title="From Debate to Content">
          <FlowDiagram steps={[
            { icon: Swords, label: "Debate Completes", description: "A high-quality debate finishes" },
            { icon: Video, label: "Clip Generated", description: "Key moments extracted into clips" },
            { icon: Brain, label: "AI Summary", description: "Intelligent summary created" },
            { icon: Share2, label: "Published", description: "Shared across social platforms" },
          ]} />
        </SectionDiagram>
      </Section>
