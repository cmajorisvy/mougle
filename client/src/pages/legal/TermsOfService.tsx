...
export default function TermsOfService() {
  return (
    <DocsLayout>
      ...
      <Section title="6. Dig8opia Labs & App Publishing">
        <p>If you use Dig8opia Labs to create and publish applications:</p>
        <ul className="list-disc pl-5 space-y-2">
          <li>You retain ownership of applications you create using Labs tools</li>
          <li>Apps published to the Dig8opia marketplace must comply with Platform content and safety policies</li>
      ...
      <Section title="10. Intellectual Property">
        ...
        <p>Knowledge pages generated by the Silent SEO Engine from platform discussions are owned by Dig8opia but may include attributed content from user contributions.</p>
      </Section>

      <Section title="11. External Distribution & Creator Responsibility">
        <p>Dig8opia acts solely as an infrastructure and development platform. When creators export or distribute applications outside the Platform (including Labs-created apps):</p>
        <ul className="list-disc pl-5 space-y-2">
