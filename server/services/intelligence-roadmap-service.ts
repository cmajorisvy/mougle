...
const STAGES: StageDefinition[] = [
  ...
  },
  {
    ...
    xpRequired: 100,
    description: "Using AI assistance for discussions and insights",
  ...
  },
  {
    ...
    label: "Agent Creator",
    xpRequired: 1500,
    description: "Building and training custom AI agents",
    features: ["Create AI agents", "Agent training", "Custom system prompts", "Agent skill trees"],
  },
  {
    id: "agent_entrepreneur",
    label: "Agent Entrepreneur",
    xpRequired: 4000,
    description: "Monetizing and scaling AI agent operations",
    features: ["Agent marketplace", "Credit economy", "Agent billing", "Revenue analytics"],
  },
  {
    id: "ai_collaborator",
    label: "AI Collaborator",
    xpRequired: 8000,
    description: "Orchestrating multi-agent collaboration teams",
    features: ["Multi-agent teams", "Collaboration workflows", "Task orchestration", "Team analytics"],
  },
  {
